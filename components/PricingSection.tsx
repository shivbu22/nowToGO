      ...
      <div className="max-w-5xl mx-auto">
        <div className={`transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-center text-slate-500 mb-12 max-w-2xl mx-auto">
            Affordable packages designed for every type of adventurer. Round-trip transport from Ghaziabad included in all packages!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          ...
          >
            <div className="text-center mb-6">
              <span className="bg-slate-100 text-slate-600 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">Solo Adventurer</span>
              <h3 style={styles.headerFont} className="text-4xl font-extrabold text-slate-900 mt-4">₹5,800</h3>
              <p className="text-sm text-slate-500">per person</p>
            </div>
            <ul className="space-y-3 mb-8 text-slate-600">
              <li className="flex items-center gap-2 font-semibold"><Bus className="w-4 h-4 text-blue-500" /> Ghaziabad ↔ Ghaziabad Transport</li>
